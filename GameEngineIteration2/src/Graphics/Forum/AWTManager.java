...
public final class AWTManager{
    private int Frame = 0,x=0,z=0,Width=0,Height=0;
    private double[][] points;
    protected ArrayList<double[][]> GUIPoints = new ArrayList();
    protected ArrayList<Component> GUIComp = new ArrayList();
    public AWTManager(int i,double[][] points){
        this.Frame = i;
        this.points = points;
    }
    ...
    public void setUIPoints(double[][] points){
        this.points = points;
    }
    public double[][] getUIPoints(){
        return this.points;
    }
